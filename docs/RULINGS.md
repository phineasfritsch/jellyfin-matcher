...
124 rulings. 89 argued in a design document; the rest are
...
| **R46** | _at its citation_ | `src/ui/components/Lobby.tsx:218` +1 |
...
| **R67** | _at its citation_ | `server/index.ts:145` |
