...
[![tests](https://img.shields.io/badge/tests-750%20in%2044%20files-1c7a52)](CONTRIBUTING.md#the-one-command)
...
`npm run gate` is the one command: typecheck, the suite, the pinned claims, and a production build, each numbered and counted, non-zero if anything drops. Currently 750 cases across 44 files.
