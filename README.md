...
[![tests](https://img.shields.io/badge/tests-1147%20in%2055%20files-1c7a52)](CONTRIBUTING.md#the-one-command)
...
`npm run gate` is the one command: typecheck, the suite, the pinned claims, and a production build, each numbered and counted, non-zero if anything drops. Currently 1147 cases across 55 files.
