...
[![tests](https://img.shields.io/badge/tests-694%20in%2042%20files-1c7a52)](CONTRIBUTING.md#the-one-command)
...
`npm run gate` is the one command: typecheck, the suite, the pinned claims, and a production build, each numbered and counted, non-zero if anything drops. Currently 694 cases across 42 files.
