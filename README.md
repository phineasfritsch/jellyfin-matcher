...
[![tests](https://img.shields.io/badge/tests-606%20in%2037%20files-1c7a52)](CONTRIBUTING.md#the-one-command)
...
`npm run gate` is the one command: typecheck, the suite, the pinned claims, and a production build, each numbered and counted, non-zero if anything drops. Currently 606 cases across 37 files.
