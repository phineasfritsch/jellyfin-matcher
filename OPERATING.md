...
|---|---|---|
| G1 | `tsc --noEmit` | clean |
| G2 | `vitest run`, and the **counts** | 212 cases in 15 files |
| G3 | pinned claims still pinned | 100 |
...
`src/ui/__tests__/pins.test.ts` holds 100 claims that nothing else asserts:
...
2. **The gate, numbered, with today's numbers**: 212 cases, 15 files, 100 pins.
