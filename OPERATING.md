...
|---|---|---|
| G1 | `tsc --noEmit` | clean |
| G2 | `vitest run`, and the **counts** | 385 cases in 26 files |
| G3 | pinned claims still pinned | 146 |
...
`src/ui/__tests__/pins.test.ts` holds 146 claims that nothing else asserts:
...
2. **The gate, numbered, with today's numbers**: 385 cases, 26 files, 146 pins.
