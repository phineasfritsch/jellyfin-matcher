...
|---|---|---|
| G1 | `tsc --noEmit` | clean |
| G2 | `vitest run`, and the **counts** | 466 cases in 29 files |
| G3 | pinned claims still pinned | 170 |
...
`src/ui/__tests__/pins.test.ts` holds 170 claims that nothing else asserts:
...
2. **The gate, numbered, with today's numbers**: 466 cases, 29 files, 170 pins.
