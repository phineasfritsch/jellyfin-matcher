...
|---|---|---|
| G1 | `tsc --noEmit` | clean |
| G2 | `vitest run`, and the **counts** | 321 cases in 19 files |
| G3 | pinned claims still pinned | 124 |
...
`src/ui/__tests__/pins.test.ts` holds 124 claims that nothing else asserts:
...
2. **The gate, numbered, with today's numbers**: 321 cases, 19 files, 124 pins.
