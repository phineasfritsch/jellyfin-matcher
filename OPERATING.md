...
|---|---|---|
| G1 | `tsc --noEmit` | clean |
| G2 | `vitest run`, and the **counts** | 427 cases in 28 files |
| G3 | pinned claims still pinned | 155 |
...
`src/ui/__tests__/pins.test.ts` holds 155 claims that nothing else asserts:
...
2. **The gate, numbered, with today's numbers**: 427 cases, 28 files, 155 pins.
