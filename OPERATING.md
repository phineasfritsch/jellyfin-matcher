...
|---|---|---|
| G1 | `tsc --noEmit` | clean |
| G2 | `vitest run`, and the **counts** | 347 cases in 22 files |
| G3 | pinned claims still pinned | 134 |
...
`src/ui/__tests__/pins.test.ts` holds 134 claims that nothing else asserts:
...
2. **The gate, numbered, with today's numbers**: 347 cases, 22 files, 134 pins.
