...
|---|---|---|
| G1 | `tsc --noEmit` | clean |
| G2 | `vitest run`, and the **counts** | 415 cases in 27 files |
| G3 | pinned claims still pinned | 150 |
...
`src/ui/__tests__/pins.test.ts` holds 150 claims that nothing else asserts:
...
2. **The gate, numbered, with today's numbers**: 415 cases, 27 files, 150 pins.
