...
|---|---|---|
| G1 | `tsc --noEmit` | clean |
| G2 | `vitest run`, and the **counts** | 417 cases in 27 files |
| G3 | pinned claims still pinned | 152 |
...
`src/ui/__tests__/pins.test.ts` holds 152 claims that nothing else asserts:
...
2. **The gate, numbered, with today's numbers**: 417 cases, 27 files, 152 pins.
