...
|---|---|---|
| G1 | `tsc --noEmit` | clean |
| G2 | `vitest run`, and the **counts** | 386 cases in 26 files |
| G3 | pinned claims still pinned | 147 |
...
`src/ui/__tests__/pins.test.ts` holds 147 claims that nothing else asserts:
...
2. **The gate, numbered, with today's numbers**: 386 cases, 26 files, 147 pins.
