...
|---|---|---|
| G1 | `tsc --noEmit` | clean |
| G2 | `vitest run`, and the **counts** | 494 cases in 29 files |
| G3 | pinned claims still pinned | 175 |
...
`src/ui/__tests__/pins.test.ts` holds 175 claims that nothing else asserts:
...
2. **The gate, numbered, with today's numbers**: 494 cases, 29 files, 175 pins.
