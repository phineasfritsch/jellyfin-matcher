...
|---|---|---|
| G1 | `tsc --noEmit` | clean |
| G2 | `vitest run`, and the **counts** | 498 cases in 29 files |
| G3 | pinned claims still pinned | 177 |
...
`src/ui/__tests__/pins.test.ts` holds 177 claims that nothing else asserts:
...
2. **The gate, numbered, with today's numbers**: 498 cases, 29 files, 177 pins.
