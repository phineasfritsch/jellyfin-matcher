...
const LATESHOW: Pin[] = [
  ...
  { id: 'T92', why: 'That the winner was asked for lives on the room, so every phone sees it and it survives a reload. It was component state, private to whoever pressed the button and gone when they refreshed', find: 'winnerRequest: { by: string; title: string } | null' },
