...
const LATESHOW: Pin[] = [
  ...
  { id: 'T05', why: 'The divider between two controls is information, so it clears 3:1. #5c6272 on #0a0c12 measures 3.2:1. The glass hairline is a separate, decorative token and is deliberately not held to this (R41)', find: '--color-border: #5c6272' },
  { id: 'T06', why: 'One hue means the room, and only the room', find: '--color-super: #ffc95c' },
  { id: 'T07', why: 'One hue means mine alone', find: '--color-maybe: #5ac8fa' },
  { id: 'T08', why: 'One hue means it stops, costs, or is missing', find: '--color-destructive: #ff6b5e' },
  ...
  { id: 'T31', why: 'The vote labels specifically are rem, since they are the ones the reflow comment names', find: "text-[0.8438rem] font-semibold" },
